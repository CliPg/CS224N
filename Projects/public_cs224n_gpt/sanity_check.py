...
def test_gpt2(model_size='gpt2'):
  ...
  # result
  #"""
  print(f"my_outputs: {outputs['last_hidden_state']}")
  print(f"openai_outputs: {openai_outputs}")
  #"""

  # shape
  # have been proved to be the same
  """
  print(f"my_outputs: {outputs['last_hidden_state'].shape}")
  print(f"openai_outputs: {openai_outputs.shape}")
  """
